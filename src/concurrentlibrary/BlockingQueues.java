...
class FirstWorkerQueue implements Runnable {

	private BlockingQueue<String> blockingQueue;
	
	public FirstWorkerQueue(BlockingQueue<String> blockingQueue) {
...
class SecondWorkerQueue implements Runnable {

	private BlockingQueue<String> blockingQueue;
	
	public SecondWorkerQueue(BlockingQueue<String> blockingQueue) {
		this.blockingQueue = blockingQueue;
	}
...
public class BlockingQueues {
	...
	public static void main(String[] args) {
		...
		FirstWorkerQueue firstWorker = new FirstWorkerQueue(queue);
		SecondWorkerQueue secondWorker = new SecondWorkerQueue(queue);
